...
export const data = [
  {
    ...
    It allows the shop owner to manage their inventory, by adding, updating and removing items. Additionally, the app tracks low stock levels and alerts the owner when inventory is running low. It can also calculate profit per item.`,
  },
  {
    id: 2,
    name: "Break Time App",
